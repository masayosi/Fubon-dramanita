    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.options = jQuery.extend({
                    ...
                    fadespeed: 400,
                    jsfolder: jsFolder,
                    skinsfoldername: "http://html5box.com/html5lightbox/html5lightbox/skins/default/",
            ...
            inst.showNavigation = function() {
                ...
                if ($(".html5-nav").length >
                    0) return;
                $("body").append("<div class='html5-nav' style='display:block;position:fixed;top:390px;left:0;width:100%;height:" + inst.options.navheight + "px;z-index:9999999;'>" + "<div class='html5-nav-container' style='position:relative;margin:" + inst.options.thumbtopmargin + "px auto " + inst.options.thumbbottommargin + "px;'>" + "<div class='html5-nav-prev' style='display:block;position:absolute;cursor:pointer;width:" + inst.options.navbuttonwidth + 'px;height:100%;left:0;top:0;background:url("' + inst.options.skinsfolder +
